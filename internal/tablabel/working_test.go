...
func TestParseVerdict(t *testing.T) {
	cases := []struct {
		...
		{reply: "w says it is continuing with the dump script", letters: agentVerdictLetters, want: VerdictWorking},
		{reply: "u: asks which option to build.\nIt lists two.", letters: agentVerdictLetters, want: VerdictBlocked},
		{reply: "n only thanks the agent", letters: userVerdictLetters, want: VerdictIdle},
